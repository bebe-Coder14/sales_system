...
class AdminController extends Controller
{
    public function index(){
        ...
        return view('admin.index', compact('orders','dashboardDatas','AmountM','OrderedAmountM',
                                                'DeliveredAmountM','CanceledAmountM','TotalAmount','TotalOrderedAmount',
                                            'TotalDeliveredAmount','TotalCanceledAmount','monthlyDatas'));
    }

    /* Admin Brands Controllers */
    ...
    public function update_product(Request $request){
        ...
        return redirect() -> route('admin.products') -> with('status', 'Product has been successfully updated!');
    }
    ...
    public function store_coupon(Request $request){
        ...
        $coupon->save();
        return redirect() -> route('admin.coupons') -> with('status','Coupon has been successfully added!');
    }
    ...
    public function update_coupon(Request $request){
        ...
        $coupon->expiry_date = $request->expiry_date;
        $coupon->save();
        return redirect() -> route('admin.coupons') -> with('status','Coupon has been successfully updated!');
    }

    public function delete_coupon($id){
        $coupon = Coupon::find($id);
        $coupon->delete();
        return redirect() -> route('admin.coupons') -> with('status','Coupon has been successfully deleted!');
    }
    ...
    public function order_details($order_id) {
        ...
        // Debug output
        if (!$transaction) {
            dd("No transaction found for order_id: " . $order_id);
        }
    ...
    public function update_order_status(Request $request){
        ...
        return back()->with('status','Status has been updated');
    }
    ...
    public function update_slide(Request $request){
        ...
        $slide->save();
        return redirect()->route('admin.slides')->with('status','Slide has been updated!');
    }
    ...
    public function delete_slide($id){
        ...
        $slide->delete();
        return redirect()->route('admin.slides')->with('status','Slide has been deleted!');
    }
    ...
    public function delete_contact($id){
        ...
        $contact->delete();
        return redirect()->route('admin.contacts')->with('status','Message is now deleted');
    }
