...
<style>
    ...
    <div class="main-content-inner">
        <div class="main-content-wrap">
            <div class="flex items-center flex-wrap justify-between gap20 mb-25">
                <h3>Order Details</h3>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    @elseif($transaction->status == 'refunded')
                                        <span class="badge bg-secondary" style="font-size: 1.2em;">Refunded/Returned</span>
                                    @else
                        ...
                        <div class="col-md-3">
                            <div class="select">
                                <select name="order_status" id="order_status">
                                    ...
                                    <option value="waiting" {{$order->status =='waiting' ? "selected":""}}>Waiting for Pick-up</option> -->
