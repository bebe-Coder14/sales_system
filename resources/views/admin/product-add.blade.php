        ...
        <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data" action="{{route('admin.product.store')}}">
            ...
            <div class="wg-box">
                <fieldset class="name">
                    ...
                    <div class="text-tiny">Do not exceed over 100 characters when entering the product name.</div>
                </fieldset>
                ...
                <fieldset class="name">
                    ...
                    <div class="text-tiny">Do not exceed over 100 characters when entering the product slug.</div>
                </fieldset>
                ...
                <fieldset class="shortdescription">
                    ...
                    <div class="text-tiny">Do not exceed over 50 characters when entering the product short description.</div>
                </fieldset>
