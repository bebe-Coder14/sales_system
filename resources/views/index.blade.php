    ...
    <section class="hot-deals container">
      ...
      <div class="row">
        <div
          ...
          <h2>New Years Holiday Sale</h2>
          <h2 class="fw-bold">Up to 10% Off</h2>

          <!-- <div class="position-relative d-flex align-items-center text-left pt-xxl-4 js-countdown mb-3"
            data-date="" data-time="">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="category-banner__item border-radius-10 mb-5">
            <img loading="lazy" class="h-auto" src="{{ asset('images/testImg/phone.jpg')}}" width="690 !important"
              height="640" alt="" />
            ...
            <div class="category-banner__item-content">
              ...
              <a href="{{route('shop.index',['categories' => 1])}}" class="btn-link default-underline text-uppercase fw-medium">Shop Now</a>
            </div>
          </div>
        </div>
        <div class="col-md-6">
          <div class="category-banner__item border-radius-10 mb-5">
            <img loading="lazy" class="h-auto" src="{{ asset('images/testImg/headphone.jpg')}}" width="690"
              height="640" alt="" />
            <div class="category-banner__item-mark">
              Starting at ₱ 1000
            </div>
            <div class="category-banner__item-content">
              <h3 class="mb-0">Headphones</h3>
              <a href="{{route('shop.index', ['categories' => 6])}}" class="btn-link default-underline text-uppercase fw-medium">Shop Now</a>
            </div>
          </div>
        </div>
      </div>
