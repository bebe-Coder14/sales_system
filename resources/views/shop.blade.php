                ...
                <div class="accordion-item mb-4">
                    ...
                    <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
                        ...
                        <input class="price-range-slider" type="text" name="price_range" value="" data-slider-min="1"
                            data-slider-max="3000" data-slider-step="5"
                            ...
                            <div class="slide-split_text position-relative d-flex align-items-center"
                                ...
                                <div class="slideshow-text container p-3 p-xl-5">
                                    <h2
                                        ...
                                        Think Digital <br /><strong>ACT SMART</strong></h2>
                                    <p class="mb-0 animate animate_fade animate_btt animate_delay-5">Where visionary
                                        ideas meet groundbreaking technology to create limitless possibilities..</h6>
                                </div>
                            </div>
                        ...
                        <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
                            <div class="slide-split_text position-relative d-flex align-items-center"
                                ...
                                <div class="slideshow-text container p-3 p-xl-5">
                                    <h2
                                        class="text-uppercase section-title fw-normal mb-3 animate animate_fade animate_btt animate_delay-2">
                                        Driving Progress <br /><strong> Through Innovation</strong></h2>
                                    <p class="mb-0 animate animate_fade animate_btt animate_delay-5">Driving the digital revolution with solutions that inspire progress and change.</h6>
                                </div>
                            </div>
                            <div class="slide-split_media position-relative">
                                <div class="slideshow-bg" style="background-color: #f5e6e0;">
                        ...
                        <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
                            <div class="slide-split_text position-relative d-flex align-items-center"
                                ...
                                <div class="slideshow-text container p-3 p-xl-5">
                                    <h2
                                        class="text-uppercase section-title fw-normal mb-3 animate animate_fade animate_btt animate_delay-2">
                                        Connecting the World <br /><strong>DIGITALLY</strong></h2>
                                    <p class="mb-0 animate animate_fade animate_btt animate_delay-5">Innovating beyond limits to create technology that redefines possibility.</h6>
                                </div>
                            </div>
                            <div class="slide-split_media position-relative">
                                <div class="slideshow-bg" style="background-color: #f5e6e0;">
                                    <img loading="lazy" src="assets/images/shop/sample_banner.jpg" width="630"
                                        height="450" alt="Women's accessories"
                                        class="slideshow-bg__img object-fit-cover" />
                                </div>
                            </div>
